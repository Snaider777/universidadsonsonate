...
const BienvenidaUSO = () => {
  ...
  return (
    <div ref={ref} className="overflow-hidden bg-blue-500">
      {/* Sección con fondo mejorado */}
      <motion.div
        initial={{ opacity: 0, scale: 0.95 }}
        animate={
          inView ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 1 }
        }
        transition={{ duration: 0.8 }}
        className="relative flex flex-col md:flex-col lg:flex-row lg:w-screen justify-center items-center h-auto w-full p-4 bg-blue-500"
      >
        {/* Contenido de texto */}
        <motion.div
        ...
        >
          ...
          <motion.button
            className="bg-green-500 text-white font-semibold text-sm md:text-base lg:text-lg px-4 py-2 rounded-lg mt-2 hover:bg-green-600"
